...
void Cppjieba::Cut_With_Hmm(const string & data)
{
	_jieba.Cut(data, _words, true);
}

void Cppjieba::Cut_Without_Hmm(const string & data)
{
	_jieba.Cut(data, _words, false);
}

void Cppjieba::Cut_All(const string & data)
{
	_jieba.CutAll(data, _words);
}

void Cppjieba::Cut_For_Search(const string & data)
{
	_jieba.CutForSearch(data, _words);
}
